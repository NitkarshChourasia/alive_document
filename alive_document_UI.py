...
from run_alive_document import load_model
...
with st.sidebar:
    ...
    - [alive_document](https://github.com/NitkarshChourasia/alive_document) 
 
    """
    )
    # add_vertical_space(5)
    st.write("Made with ❤️ by Nitkarsh Chourasia")
